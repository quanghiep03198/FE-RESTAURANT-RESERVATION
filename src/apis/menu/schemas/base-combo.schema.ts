...
export const baseComboSchema = object({
	...
	discount_price: number({ message: 'Vui lòng điền giá bán' }).nullish().default(0),
	max_use_times: number({ message: 'Vui lòng nhập số lượng mở bán' })
		.min(10, 'Số lượng mở bán tối thiểu là 10')
		.nullish(),
